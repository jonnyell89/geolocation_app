    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" name="latitude" value={coords.latitude} onChange={handleChange} /><br />
                <label>Longitude: </label>
                <input type="text" name="longitude" value={coords.longitude} onChange={handleChange} /><br />
